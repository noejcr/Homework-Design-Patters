class Subject (object): #Represents what is being 'observed'
    ...
    def __init__(self):
        self._observers = [] #This where references to all the observers are being hept
                            #Note that is a one-to-many realationship: ther will be one subject to be observed by multiple_observers
